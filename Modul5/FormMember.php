...
if ($form == 'tambah') {
    if (isset($_POST['nama_member'])) {
        ...
        TambahMember($connection, $nama_member, $nomor_member, $alamat, $tgl_mendaftar, $tgl_terakhir_bayar);
    }
} else if ($form == 'update') {
    ...
    if (isset($_POST['nama_member'])) {
        ...
        $tgl_mendaftar = $_POST['tgl_mendaftar'];
        $tgl_terakhir_bayar = $_POST['tgl_terakhir_bayar'];
        UpdateMember($connection, $nama_member, $nomor_member, $alamat, $tgl_mendaftar, $tgl_terakhir_bayar, $id);
    }
} else if ($form == 'delete') {
